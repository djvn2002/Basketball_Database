...
# NBA_TEAM_PLAYOFF_OPP_TOTAL.R

# The purpose of this file is to grab an aggregate of seasonal per game data by opponent team data.
...
load(file = file.path(team_fp,"NBA_TEAM_PLAYOFF_OPP_TOTAL.rda"))

# Aggregating based by dividing games played for each player by season
nba_team_ply_opp_per_game <- nba_team_ply_opp_total %>%
...
save(nba_team_ply_opp_per_game,file = file.path(team_fp,"NBA_TEAM_PLAYOFF_OPP_PER_GAME.rda"))