...
men_identity <- load_mbb_player_box(seasons = 2014:most_recent_mbb_season()) %>%
...
mens_college <- load_mbb_pbp(seasons = 2014:most_recent_mbb_season()) %>%
