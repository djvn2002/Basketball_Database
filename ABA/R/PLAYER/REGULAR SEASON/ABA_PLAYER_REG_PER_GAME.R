...
load(file = file.path(player_fp,"ABA_PLAYER_REG_TOTAL.rda"))

# Aggregating based by dividing games played for each player by season
aba_reg_per_game <- aba_reg_total %>%
...
save(aba_reg_per_game,file = file.path(player_fp,"ABA_PLAYER_REG_PER_GAME.rda"))

# Display message to confirm save
print("aba_reg_per_game table has been saved to ABA_PLAYER_REG_PER_GAME.rda")