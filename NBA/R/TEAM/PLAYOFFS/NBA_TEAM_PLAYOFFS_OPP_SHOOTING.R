...
nba_team_ply_opp_shooting <- nba_ply_opp_shooting_parallel %>%
  rename(Rk = Var.1,
         Team = Var.2,
         G = Var.3,
         MP = Var.4,
...
nba_team_ply_opp_shooting <- nba_team_ply_opp_shooting %>%
  ...
  mutate( From = as.numeric(substr(nba_team_ply_opp_shooting$Season,1,4)),
          To = as.numeric(substr(nba_team_ply_opp_shooting$Season,6,9))) %>%
...
# Read in standings data to join into nba_team_ply_opp_shooting
