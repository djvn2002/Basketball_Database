...
"C:\Program Files\R\R-4.4.1\bin\Rscript.exe" "C:\Users\djvia\OneDrive\Documents\Blog Website\Basketball_Database\SHOT APP\WNBA\wnba_shots.R" >> %log_file% 2>&1
if %ERRORLEVEL% neq 0 (
...
"C:\Program Files\R\R-4.4.1\bin\Rscript.exe" "C:\Users\djvia\OneDrive\Documents\Blog Website\Basketball_Database\SHOT APP\NBA\nba_shots.R" >> %log_file% 2>&1
if %ERRORLEVEL% neq 0 (
...
"C:\Program Files\R\R-4.4.1\bin\Rscript.exe" "C:\Users\djvia\OneDrive\Documents\Blog Website\Basketball_Database\SHOT APP\NCAA\mens_college_data.R" >> %log_file% 2>&1
if %ERRORLEVEL% neq 0 (
...
"C:\Program Files\R\R-4.4.1\bin\Rscript.exe" "C:\Users\djvia\OneDrive\Documents\Blog Website\Basketball_Database\SHOT APP\NCAA\womens_college_data.R" >> %log_file% 2>&1
if %ERRORLEVEL% neq 0 (
