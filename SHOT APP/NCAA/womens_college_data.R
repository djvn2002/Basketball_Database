...
women_identity <- load_wbb_player_box(seasons = 2014:most_recent_wbb_season()) %>%
...
womens_college <- load_wbb_pbp(seasons = 2014:most_recent_wbb_season()) %>%
