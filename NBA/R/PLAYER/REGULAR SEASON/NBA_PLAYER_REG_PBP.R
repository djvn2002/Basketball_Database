...
# This file will contain scrape code for player stats based by play by play stats
...
# Cleaning up tables
nba_reg_pbp <- convert_to_numeric(nba_reg_pbp_parallel)
