...
nba_team_reg_opp_shooting <- scrape_data_in_batches(nba_urls)
...
nba_team_reg_opp_shooting$Team <- gsub("\\*", "", nba_team_reg_opp_shooting$Team)
...
nba_team_reg_opp_shooting <- nba_team_reg_opp_shooting %>%
  ...
  mutate( From = as.numeric(substr(nba_team_reg_opp_shooting$Season,1,4)),
          To = as.numeric(substr(nba_team_reg_opp_shooting$Season,6,9))) %>%
...
# Read in standings data to join into nba_team_reg_opp_shooting
