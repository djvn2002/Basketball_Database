...
# NBA_TEAM_REG_OPP_TOTAL.R

# The purpose of this file is to grab an aggregate of opponent seasonal per game data by team.
...
load(file = file.path(team_fp,"NBA_TEAM_REG_OPP_TOTAL.rda"))
...
save(nba_team_reg_opp_per_game,file = file.path(team_fp,"NBA_TEAM_REG_OPP_PER_GAME.rda"))
